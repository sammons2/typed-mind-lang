...
export const examples = {
  longform: {
    todoApp: `# Longform syntax is for humans
program TodoApp {
  entryPoint: models
  version: "1.0.0"
}
...
component TodoForm {
  ...
  containedBy: [TodoApp]
    ...
    microservices: `# Longform syntax is for humans
program ECommerce {
  entryPoint: services
  version: "1.0.0"
}
...
dto Order {
  ...
  fields: [
    ...
    reactApp: `# Longform syntax is for humans
program ReactApp {
  entryPoint: ui
  version: "1.0.0"
}
...
function setTheme {
  ...
  affects: [App]
    ...
    apiGateway: `# Longform syntax is for humans
program APIGateway {
  entryPoint: gateway
  version: "1.0.0"
}
...
runParameter RATE_LIMIT {
  ...
  shortform: {
    todoApp: `# Shortform syntax is for LLMs
...
TodoForm & "Form for creating todos"
  < [TodoApp]`,
    ...
    microservices: `# Shortform syntax is for LLMs
...
Order % "Order entity"
  ...
  - status: OrderStatus "Order status"`,
    ...
    reactApp: `# Shortform syntax is for LLMs
ReactApp -> ui v1.0.0
...
setTheme :: (theme: Theme) => void
  ...
  ~ [App]`,
    ...
    apiGateway: `# Shortform syntax is for LLMs
