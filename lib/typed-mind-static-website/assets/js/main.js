...
function setupSyntaxToggles() {
  ...
  toggleContainers.forEach(container => {
    ...
    const codeBlock = container.parentElement;
    const longformCode = codeBlock.querySelector('.longform-code');
    const shortformCode = codeBlock.querySelector('.shortform-code');
